...
public class NegaMaxFelipePlayer extends CheckersPlayer implements GradedCheckersPlayer
{
    ...
    public NegaMaxFelipePlayer(String name, int side)
    { 
        super(name, side);
    ...
    {    	
    	...
    	while(depthCutOff < this.depthLimit){
        	this.pruneCount = 0;
        	int score = negamax(bs,Integer.MIN_VALUE,Integer.MAX_VALUE,depthCutOff,0,true);
    		depthCutOff++;
